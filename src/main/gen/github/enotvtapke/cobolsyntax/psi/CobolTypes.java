...
public interface CobolTypes {
  ...
  IElementType GE = new CobolTokenType("GE");
  IElementType GIVING = new CobolTokenType("GIVING");
  IElementType GT = new CobolTokenType("GT");
  ...
  IElementType PLUS = new CobolTokenType("PLUS");
  IElementType POWER = new CobolTokenType("POWER");
  ...
  IElementType SLASH = new CobolTokenType("SLASH");
  IElementType STAR = new CobolTokenType("STAR");
