...
public class CobolUntilClauseImpl extends ASTWrapperPsiElement implements CobolUntilClause {

  public CobolUntilClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitUntilClause(this);
  }
