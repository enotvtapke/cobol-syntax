...
public class CobolPrimaryExpressionImpl extends ASTWrapperPsiElement implements CobolPrimaryExpression {

  public CobolPrimaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
