...
public class CobolPerformStatementImpl extends ASTWrapperPsiElement implements CobolPerformStatement {
  ...
  @Override
  @Nullable
  public CobolPerformInline getPerformInline() {
    return findChildByClass(CobolPerformInline.class);
  }

  @Override
  @Nullable
  public CobolPerformOutOfLine getPerformOutOfLine() {
    return findChildByClass(CobolPerformOutOfLine.class);
  }
